...
parser.add_argument('--dataroot', default='/Users/julie/Documents/University/CS/Capstone/Dataset')
parser.add_argument('--ckpt_path', default='/Users/julie/Documents/University/CS/Capstone/Capstone_Project_Fall_2022/DUA-master/ckpt/gaussian_noise.pt')
...
for args.level in severity:
    print('Starting DUA for Level ', args.level)
    all_errors = []
    for args.corruption in common_corruptions:
        ...
        #==== get embedding before BN
        # net.eval()
        # embed_list, output_list, labels_list = embed(teloader, net)
        # torch.save(embed_list, '/Users/julie/Documents/University/CS/Capstone/Capstone_Project_Fall_2022/DUA-master/result/embed.npy')
        # torch.save(labels_list, '/Users/julie/Documents/University/CS/Capstone/Capstone_Project_Fall_2022/DUA-master/result/labels.npy')
        # torch.save(output_list, '/Users/julie/Documents/University/CS/Capstone/Capstone_Project_Fall_2022/DUA-master/result/output.npy')
        #==== end
