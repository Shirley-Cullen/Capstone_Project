...
def train_target(args):
    ...
    modelpath = args.output_dir+"/target_F_NRC_BN_2021_5.pt"
    print(modelpath)
    netF.load_state_dict(torch.load(modelpath))
    modelpath = args.output_dir+"/target_B_NRC_BN_2021_5.pt"
    # modelpath = './PT/BN/target_B_BN2_2021_LPA.pt'
    # modelpath = args.output_dir_src + "/source_B.pt"
    netB.load_state_dict(torch.load(modelpath))
    modelpath = args.output_dir+"/target_C_NRC_BN_2021_5.pt"
    ...
    with torch.no_grad():
        ...
        torch.save(embed_list,'./NRC_embed_BN.npy')
        torch.save(lables_list,'./NRC_lables_BN.npy')
        torch.save(output_list,'./NRC_output_BN.npy')
