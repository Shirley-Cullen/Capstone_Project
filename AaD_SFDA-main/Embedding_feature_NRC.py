...
def train_target(args):
    ...
    modelpath = args.output_dir+"/target_F_NRC_2021_5.pt"
    print(modelpath)
    netF.load_state_dict(torch.load(modelpath))
    modelpath = args.output_dir+"/target_B_NRC_2021_5.pt"
    # modelpath = './PT/BN/target_B_BN2_2021_LPA.pt'
    # modelpath = args.output_dir_src + "/source_B.pt"
    netB.load_state_dict(torch.load(modelpath))
    modelpath = args.output_dir+"/target_C_NRC_2021_5.pt"
    ...
    with torch.no_grad():
        ...
        torch.save(embed_list,'./NRC_embed.npy')
        torch.save(lables_list,'./NRC_lables.npy')
        torch.save(output_list,'./NRC_output.npy')
...
if __name__ == "__main__":
    ...
    for i in range(len(names)):
        ...
        args.out_file = open(
            osp.join(args.output_dir, "Embed_NRC_{}.txt".format(args.tag)), "w"
        )
